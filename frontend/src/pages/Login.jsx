    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-20 bg-gray-50">
      ...
      >
        ...
        <div className="mt-4 text-right">
          <button
            className="text-sm text-[#FF6347] hover:underline cursor-pointer"
            type="button"
          >
            Quên mật khẩu?
          </button>
        ...
        <button
          className="mt-6 w-full h-12 rounded-full text-white bg-[#FF6347] hover:bg-[#e5533d] transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
          disabled={isLoading}
          type="submit"
        >
          {isLoading ? (
